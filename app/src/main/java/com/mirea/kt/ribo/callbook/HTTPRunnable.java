...
public class HTTPRunnable implements Runnable {
    ...
    public String getReasponseBody() {
        return reasponseBody;
    }
        ...
        if (this.address != null && !this.address.isEmpty()) {
            try {
                ...
                if(responseCode == 200){
                    ...
                    reasponseBody = sbResponse.toString();
                }else {
                    System.out.println("Eror! Bad response Code");
                }
